...
- **Páginas de plataforma** (`/plataforma/pc|xbox|playstation|nintendo|sega|mobile`) com chips por console.
...
app/
  ...
  (app)/                        páginas com header fixo + footer
    ...
    jogos/                      Meus Jogos
    plataforma/[familia]/       PC, Xbox, PlayStation, Nintendo, Sega, Mobile
    perfil/, sobre/
